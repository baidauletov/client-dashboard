            ...
            <vs-col vs-w="9">
                ...
                <div v-if="currentMenu == 3" class="login-edit__main-item">
                    <div class="login-edit__list">
                        ...
                        <vs-row v-for="(item, index) of transactions" :key="index" class="login-edit__list-item">
                            <vs-col vs-w="3" class="login-edit__list-item-when">
                                <span class="login-edit__list-item-time">{{ item.time }}</span>
                                <span class="login-edit__list-item-date">{{ item.date }}</span>
                            </vs-col>
                            <vs-col vs-w="6" class="login-edit__list-item-content">
                            ...
                            <vs-col vs-w="3" class="login-edit__list-item-bottom">
